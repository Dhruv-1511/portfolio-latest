  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={clsx(
          "group relative aspect-square w-full cursor-pointer overflow-hidden rounded-3xl",
        ...
        {isExpanded && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-4 z-50 mx-auto max-w-5xl overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-slate-900/95 via-slate-900/90 to-slate-950/95 shadow-2xl backdrop-blur-2xl md:inset-8 md:max-w-6xl"
